...
export default defineConfig({
  extract: {
    include: ['src/**/*.{html,jsx,css,tsx,svelte}'],
  ...
  shortcuts: {
    'bg-primary': 'bg-white dark:(bg-dark-500)',
    'bg-header': 'bg-white bg-opacity-40 dark:(bg-dark-200 bg-opacity-40)',
    'text-primary': 'text-dark-50 dark:(text-white text-opacity-80)',
    'text-secondary': 'text-dark-50 text-opacity-70 dark:(text-white text-opacity-60)',
    ...
    'underline-theme': 'text-theme border-b border-theme-700 dark:border-theme-300',
